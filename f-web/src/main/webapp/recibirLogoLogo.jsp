...
<%
	...
	String directorio_ruta = application.getRealPath("imagenes")+"/logosLogos/";
	...
	//i=nombres.length;
								...
								if (i == nombres.length - 1) {
									if (sizeInBytes <= tamano_maximo_archivo) {
										...
										int ultima = bAdministrarPublicaciones.actualizarLogo(id);
										
										File uploadedFile = new File(directorio_ruta + "logo_financiador_"+id+".jpg");
										item2.write(uploadedFile);
										
										bAdministrarPublicaciones.actualizarArchivoLogo(new File(directorio_ruta + "logo_financiador_"+id+".jpg"), id);
...
<input class="searchbutton" name="btnVolver" id="btnVolver"
	...
	onclick="document.form1.action='subirLogoLogo.jsp'; document.form1.submit(); return false;" /></center>
<%
	}
%>
</form>
