...
<%
	...
	String directorio_ruta = application.getRealPath("imagenes")+"/archivosTemas2/";
	...
	//i=nombres.length;
								...
								if (i == nombres.length - 1) {
									if (sizeInBytes <= tamano_maximo_archivo) {
										...
										int ultima = bAdministrarPublicaciones.actualizarArchivoTema2(id, "tema_id-"+id+"."+ext.toLowerCase(),contentType);
										
										
										
										bAdministrarPublicaciones.actualizarArchivov32(new File(directorio_ruta + "tema_id-"+id+"."+ext.toLowerCase()),id);
...
<input class="searchbutton" name="btnVolver" id="btnVolver"
	...
	onclick="document.form1.action='subirArchivoTema2.jsp'; document.form1.submit(); return false;" /></center>
<%
	}
%>
</form>
