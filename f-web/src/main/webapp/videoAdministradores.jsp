			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Video-tutorial: Uso del software por parte de los administradores del software</h4>


<br/><br/>

<iframe width="560" height="315" src="https://www.youtube.com/embed/AjRNxJ_4Eco" frameborder="0" allowfullscreen></iframe>
