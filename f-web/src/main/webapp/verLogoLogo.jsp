...
int sw= 0;
Object[] financiador = bAdministrarPublicaciones.getLogo(Integer.parseInt(id));
...
<%if(sw==0){ %>
<img src="imagenes/logosLogos/logo_financiador_<%=id %>.jpg" alt="CLIENTE" title="CLIENTE"/>

<%}else{ %>
<img src="/f-web/ver_foto_logo.jsp?id=<%=financiador[0] %>" alt="CLIENTE" title="CLIENTE"/>
<% }%>
</div>
